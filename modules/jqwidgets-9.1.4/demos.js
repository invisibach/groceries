...
function getDemoTheme() {
    ...
    var url = "./modules/jqwidgets-9.1.4/styles/jqx." + theme + '.css';
    if (theme === "light" || theme === "dark") {
		...
		{
			  url = "./modules/jqwidgets-9.1.4/styles/jqx." + theme + '-ie.css';
		}
	}
	if (window.location.href.toString().indexOf("angularjs") >= 0) {
        var loc = window.location.href.toString();
        url = "./modules/jqwidgets-9.1.4/styles/jqx." + theme + '.css';
